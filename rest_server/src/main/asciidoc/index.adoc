...
// .Resposta
// include::target/snippets/playInvalidToken/http-response.adoc[]

// Quando o identificador fornecido é válido, mas o jogo ainda não começou, o seguinte JSON é retornado:

// .Resposta
// include::target/snippets/playGameHasNotStartedYet/http-response.adoc[]
...
.Requisição
include::target/snippets/playIndicesOutOfBounds/http-request.adoc[]

.Resposta
include::target/snippets/playIndicesOutOfBounds/http-response.adoc[]

Há, ainda, o caso de a jogada ser válida, mas o jogador não estar em sua vez. 
Nessa situação, o servidor retorna o seguinte:

.Resposta
include::target/snippets/playNotYourTurn/http-response.adoc[]

Caso o jogo já tenha acabado, o servidor responde com o seguinte JSON:

.Resposta
include::target/snippets/playGameOver/http-response.adoc[]
...
.Resposta
include::target/snippets/playCellNotAvailable/http-response.adoc[]
...
include::target/snippets/gameStatusOk/request-parameters.adoc[]
...
include::target/snippets/gameStatusOk/response-fields.adoc[]
...
.Requisição
include::target/snippets/gameStatusOk/http-request.adoc[]

.Resposta
include::target/snippets/gameStatusOk/http-response.adoc[]
