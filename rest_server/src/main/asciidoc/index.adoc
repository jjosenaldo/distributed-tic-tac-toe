...
Outra situação de erro é quando o jogador tenta jogar numa posição fora dos limites do tabuleiro. 
...
Finalmente, suponha que a posição (0,0) do tabuleiro já esteja ocupada, 
